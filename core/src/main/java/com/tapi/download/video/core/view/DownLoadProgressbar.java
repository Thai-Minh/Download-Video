...
public class DownLoadProgressbar extends View {
    ...
    private static final int PROGRESS_PADDING = 1; //dp
    private static final int LINE_MOVE_RIGHT = 5; //dp
    private static final int LINE_SPACE = 7; //dp
    ...
    private void init(Context context) {
        ...
        lineMoveRight = Utils.convertDpToPixel(LINE_MOVE_RIGHT, context);
        lineSpace = Utils.convertDpToPixel(LINE_SPACE, context);
        ...
        linePaint.setStrokeWidth(Utils.convertDpToPixel(LINE_WIDTH, context));
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        if (w != oldw || h != oldh) {
            ...
            float progressPadding = Utils.convertDpToPixel(PROGRESS_PADDING, mContext);
            progressRect = new RectF(progressPadding, progressPadding, w - progressPadding, h - progressPadding);
            progressGradient = new LinearGradient(progressRect.left, progressRect.top, progressRect.right, progressRect.top, START_PROGRESS_COLOR, END_PROGRESS_COLOR, TileMode.CLAMP);
