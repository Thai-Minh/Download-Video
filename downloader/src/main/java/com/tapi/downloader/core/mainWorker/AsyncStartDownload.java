...
import com.tapi.downloader.appConstants.DispatchEcode;
import com.tapi.downloader.appConstants.DispatchElevel;
import com.tapi.downloader.core.chunkWorker.Moderator;
import com.tapi.downloader.core.chunkWorker.Rebuilder;
...
//					DispatchEcode.EXCEPTION, DispatchElevel.OPEN_CONNECTION);
            ...
            if (urlConnection != null) {
//            Log.e(TAG, "task id: " + task.id + "task audioId: " + task.audioTaskId + " task videoId: " + task.videoTaskId);
