...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private final String CREATE_TABLE_TASKS =
            "CREATE TABLE IF NOT EXISTS " + TABLES.TASKS + " ("
                    ...
                    + TASKS.COLUMN_VIDEO_TASK_ID + " INTEGER, "
                    + TASKS.COLUMN_AUDIO_TASK_ID + " INTEGER, "
                    + TASKS.COLUMN_NAME + " VARCHAR( 128 ) NOT NULL, "
                    + TASKS.COLUMN_SIZE + " INTEGER, "
                    + TASKS.COLUMN_COMMON_SIZE + " INTEGER, "
                    + TASKS.COLUMN_STATE + " INT( 3 ), "
                    + TASKS.COLUMN_COMMON_STATE + " INT( 3 ), "
                    + TASKS.COLUMN_URL + " VARCHAR( 256 ), "
                    + TASKS.COLUMN_THUMBNAIL_URL + " VARCHAR( 256 ), "
                    + TASKS.COLUMN_DURATION + " INTEGER, "
                    + TASKS.COLUMN_COMPLETE_TIME + " INTEGER, "
                    ...
                    + TASKS.COLUMN_SERVER_ID + " VARCHAR(256),"
                    +TASKS.COLUMN_PERCENT_COMMON+ " INTEGER "
                    + " ); ";
